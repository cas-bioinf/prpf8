...
```{r}
comparisons_pred_d17_4w <- predict_comparisons(fit_d17_4w, d17_4w, comparisons_d17_4w_eff, c("wt", "wt"), c( "het", "d17"))
...
```{r}
plot_all_d17_4w <-  plot_all_comparisons(comparisons_pred_d17_4w)
plot_all_d17_4w
...
```
```{r}
comparisons_lin_pred_d17_4w <- predict_comparisons(fit_d17_4w, d17_4w, comparisons_lin_d17_4w_eff, c("wt", "wt"), c( "het", "d17"))
...
```{r}
plot_all_lin_d17_4w <- plot_all_comparisons(comparisons_lin_pred_d17_4w)
plot_all_lin_d17_4w

ggsave(here::here("local_temp_data/comparisons_lin_d17_4w.svg"), plot = plot_all_lin_d17_4w)
```
...
```{r}
plot_all_d17_8w <-  plot_all_comparisons(comparisons_pred_d17_8w)
plot_all_d17_8w
...
```{r}
plot_all_lin_d17_8w <- plot_all_comparisons(comparisons_lin_pred_d17_8w)
plot_all_lin_d17_8w

ggsave(here::here("local_temp_data/comparisons_lin_d17_8w.svg"), plot = plot_all_lin_d17_8w)
```
...
```{r}
plot_all_N_4w <-  plot_all_comparisons(comparisons_pred_N_4w)
plot_all_N_4w
...
```{r}
plot_all_lin_N_4w <- plot_all_comparisons(comparisons_lin_pred_N_4w)
plot_all_lin_N_4w

ggsave(here::here("local_temp_data/comparisons_lin_N_4w.svg"), plot = plot_all_lin_N_4w)
```
...
```{r}
plot_all_N_12w <-  plot_all_comparisons(comparisons_pred_N_12w)
plot_all_N_12w
...
```{r}
plot_all_lin_N_12w <- plot_all_comparisons(comparisons_lin_pred_N_12w)
plot_all_lin_N_12w

ggsave(here::here("local_temp_data/comparisons_lin_N_12w.svg"), plot = plot_all_lin_N_12w)
```
