...
```{r}
comparisons_pred_d17_4w <- predict_comparisons_genotype(fit_d17_4w, comparisons_eff, "wt", "d17")
ratios_observed_d17_4w <- compute_ratios_observed(d17_4w_model, comparisons)
```
...
```{r}
plot_detailed_comparisons(comparisons, comparisons_pred_d17_4w, ratios_observed_d17_4w)
```
...
```{r}
comparisons_pred <- predict_comparisons(fit_d17_8w, comparisons_eff)
ratios_observed <- compute_ratios_observed(d17_8w_model, comparisons)
```
...
```{r}
comparisons_pred_N_4w <- predict_comparisons(fit_N_4w, comparisons_eff)
ratios_observed_N_4w <- compute_ratios_observed(N_4w_model, comparisons)
```
